// let gifsee = function (img) {
//   this.element = img;
//   console.log(img, this.element);
...
//       setTimeout((this.circleText = this.circle.children[0]), 6000);
